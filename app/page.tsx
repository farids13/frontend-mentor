  ...
  return (
      <div className={`font-josefin min-h-screen justify-center flex items-center `}>
        ...
        <main className={`relative flex flex-col justify-start items-center rounded-lg h-[1080px] w-[1920px] text-white bg-[url('/bg-hero.jpg')] bg-center bg-no-repeat bg-cover`}>
          ...
          <button onClick={() => !session ?  signIn('google') : signOut()} className='text-white text-2xl mt-10 flex border-2 items-center bg-orange-300 bg-opacity-20 border-white h-[60px] px-10 rounded-full '>
            <Image src={googleImg} alt="Google" className='mr-5' width={40} />
