...
import { faBell, faBellSlash, faCalendar, faChevronCircleDown, faChevronCircleUp, faChevronDown, faList, faListUl, faUserCircle } from '@fortawesome/free-solid-svg-icons'; 
...
const Navbar = () => {
  ...
  return (
    ...
    <div className="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
        ...
        <img src="/kasir/assets/logo.png" className="w-10 flex-none" />
        <strong className="capitalize ml-1 flex-1">cleopatra</strong>
        <button
            id="sliderBtn"
            className="flex-none text-right text-gray-900 md:block"
        >
            <i className="fad fa-list-ul" />
            <FontAwesomeIcon icon={faListUl} className={iconSize} />
        </button>
        </div>
        {/* end logo */}
        {/* navbar content toggle */}
        <button id="navbarToggle" className="md:block md:fixed right-0 mr-6">
        <i className="fad fa-chevron-double-down" />
        <FontAwesomeIcon icon={faChevronDown} className={iconSize} />
        </button>
        ...
        <div className="text-gray-600 md:w-full md:flex md:flex-row md:justify-evenly md:pb-10 md:mb-10 md:border-b md:border-gray-200">
            ...
            <FontAwesomeIcon icon={faCalendar} className={iconSize} />
            </a>
        </div>
        {/* end left */}
        {/* right */}
        <div className="flex flex-row-reverse items-center">
            ...
            <button className="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                ...
                <img className="w-full h-full object-cover" src="/kasir/assets/user.svg" />
                </div>
                ...
                <FontAwesomeIcon icon={faChevronCircleDown} className='h-5' />
                </div>
            </button>
            
            <button className="fixed top-0 left-0 z-10 w-full h-full menu-overflow" />
            <div className="text-gray-500 menu md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
                {/* item */}
                <a
